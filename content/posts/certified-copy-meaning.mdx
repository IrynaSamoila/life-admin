...
The copy is used instead of the original, so you don’t have to send important documents by post.
...
In these situations, digital copies or PDFs are normally enough unless explicitly stated otherwise.
...
- keep originals of important documents safe
