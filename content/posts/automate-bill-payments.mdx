...
If you’re not fully sure what subscriptions you’re currently paying for, this guide to [tracking subscriptions](/blog/track-subscriptions) helps you audit them before automating.
...
If you notice prices creeping up, consider [switching utility providers](/blog/switch-utility-providers) instead of accepting automatic increases.
...
**Setup process:**
1. Add to a shared calendar with 7-day advance notice (see this [minimal annual task system](/blog/annual-tasks-system) for a simple structure)
